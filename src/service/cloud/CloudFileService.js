...
const CloudFileServiceClass = class {
  ...
  requestMoveToObject = async (file_path, is_folder = true, content_id = null, response_url = null, response_data = null, method = 'POST') => {
    ...
    return this.requestMoveToObjectByList(file_path, file_list, is_folder, content_id, response_url, response_data, method)
  }
  ...
  requestMoveToArchive = async (file_path, is_folder = true, content_id = null, response_url = null, response_data = null, method = 'POST') => {
    ...
    return this.requestMoveToArchiveByList(file_path, file_list, is_folder, content_id, response_url, response_data, method)
  }
  ...
  requestCopyToArchive = async (file_path, is_folder = true, content_id = null, response_url = null, response_data = null, method = 'POST') => {
    let file_list = null
    if (!is_folder) {
      file_list = await this.getFileList(file_path)
    }
    return this.requestCopyToArchiveByList(file_path, file_list, is_folder, content_id, response_url, response_data, method)
  }

  requestCopyToArchiveByList = async (file_path, file_list = null, is_folder = true, content_id = null, response_url = null, response_data = null, method = 'POST') => {
    if (!is_folder && (!file_list || file_list.length === 0)) {
      return false
    }
    const cloud_file_info = this.getCloudFileInfo(file_path, file_list, is_folder, content_id)
  ...
  requestDownloadObject = async (download_path, file_path, is_folder = true, content_id = null, response_url = null, response_data = null, method = 'POST') => {
    ...
    return this.requestDownloadObjectByList(file_path, file_list, is_folder, content_id, response_url, response_data, method)
  }
